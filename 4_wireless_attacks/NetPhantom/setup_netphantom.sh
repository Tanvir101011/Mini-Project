...
# Install dependencies for NetPhantom
echo "Installing NetPhantom dependencies..."
...
echo "Run 'sudo python3 netphantom.py --help' for usage."
echo "Create a phishing page (e.g., login.html) before running."
