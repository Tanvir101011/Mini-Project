...
# Install dependencies for NetBlitz
echo "Installing NetBlitz dependencies..."
...
echo "Run 'sudo python3 netblitz.py --help' for usage."
echo "Ensure network access to target network device (e.g., router, firewall)."